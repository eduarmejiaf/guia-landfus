...
**Es cierto que en Lantus, el nivel del oficio no determina si puedes o no recolectar un recurso específico.** Todos los jugadores, independientemente de su nivel de oficio, pueden cosechar trigo, por ejemplo. Sin embargo, **el nivel del oficio sí juega un papel importante en la cantidad de recursos que obtienes y la velocidad a la que los recolectas.**

**A mayor nivel de oficio:**
...
**1. Seleccionar el objeto que deseas usar:** Acércate al objeto que deseas cosechar, pescar o utilizar. Haz clic en el objeto para seleccionarlo.

**2. Usar la acción del oficio:** En la interfaz del juego, busca la acción del oficio que deseas realizar. Por ejemplo, talar fresno, busca la acción "talar".

**3. Confirmar la acción:** Haz clic en la acción para confirmar que deseas realizarla.

<figure><img src="../.gitbook/assets/image (296).png" alt=""><figcaption></figcaption></figure>

## Cantidad de dropeo del recurso

**En Landfus, cada recurso tiene una tasa de reaparición que determina el tiempo que tarda en volver a estar disponible después de ser recolectado.** Esta tasa de reaparición se refleja en forma de **estrellas** que aparecen sobre el recurso.

**Significado de las estrellas:**

* **Estrellas completas:** El recurso está listo para ser recolectado y podrás obtener la **máxima cantidad** que te permita tu nivel del oficio.
* **Estrellas incompletas:** El recurso aún no está listo para ser recolectado y no podrás obtener la máxima cantidad.
* **Sin estrellas:** El recurso no está disponible para ser recolectado en este momento.
...
Puedes intercambiar con fresno los siguientes objetos.
...
**El oficio de Campesino en Landfus** va más allá de la simple recolección de recursos. Si bien la habilidad de **cosechar** trigo es una parte fundamental del oficio, este ofrece una **oportunidad única para obtener ogrinas**<img src="https://cdn.discordapp.com/emojis/1214652202103210075.webp?size=96&#x26;quality=lossless" alt=":Ogrina:" data-size="line"> a través de la **venta de pergaminos**.

* **Descripción:** el oficio campesino es el oficio especializado en la cosecha de trigo para intercambiarlos por pergaminos codiciado por los jugadores como el bumerang pérfido
* **Beneficios:** Los campesinos pueden obtener trigo con el que puedes Obtener pergaminos de hechizo para vender en el comercio.
* **Subir de nivel:** Puedes subir de nivel tu oficio de campesino recolectando trigo, o usando pergaminos de XP por 500<img src="https://cdn.discordapp.com/emojis/1214652202103210075.webp?size=96&#x26;quality=lossless" alt=":Ogrina:" data-size="line"> en el NPC de tienda Vip.
* **Recurso principal:** su recurso principal es el trigo y **l**a herramienta necesaria para su cosecha es la guadaña que tiene un costo de 10.000<img src="https://cdn.discordapp.com/emojis/1215392450944835624.webp?size=160&#x26;quality=lossless" alt=":Kamas:" data-size="line"> con el NPC vendedor de objetos en la casa de oficios .

<figure><img src="../.gitbook/assets/image (299).png" alt=""><figcaption></figcaption></figure>

puedes intercambiar con trigo los siguientes objetos
...
**En el juego Dofus, el oficio de minero no tiene un gran protagonismo** A diferencia de otros oficios, como el de leñador o el de pescador, que ofrecen una gran variedad de recursos y objetos, el minero solo tiene un recurso principal: **el hierro**.

**Sin embargo, no subestimes el poder del hierro** Aunque la cantidad de objetos que se pueden crear con este recurso es limitada, **el pergamino de hechizo que se puede obtener a cambio del hierro es de vital importancia para los jugadores que se dedican al PvP.**

puedes subir de nivel minando o comprando un pergamino de XP por 500<img src="https://cdn.discordapp.com/emojis/1214652202103210075.webp?size=96&#x26;quality=lossless" alt=":Ogrina:" data-size="line"> con el NPC de tienda Vip

<figure><img src="../.gitbook/assets/image (300).png" alt=""><figcaption></figcaption></figure>

Puedes intercambiar con hierro los siguientes objetos:
...
**El oficio de pescador en Landfus** te permite capturar una gran variedad de peces en diferentes zonas del juego. En Landfus, dos tipos de peces en particular son de gran importancia: **la trucha y la lubina mericana**. Sin embargo los otros tipos de peses son importantes ya que sirven como alimento para las monturas&#x20;

* **Descripción:** El pescador captura peces en los ríos y mares, que luego pueden usarse para  alimentar monturas o intercambiar por cajas de lupas.
* **Subir de nivel:** Puedes subir de nivel tu oficio de pescador pescando peces, o usando pergaminos de XP por 1.000<img src="https://cdn.discordapp.com/emojis/1214652202103210075.webp?size=96&#x26;quality=lossless" alt=":Ogrina:" data-size="line">.
* **Recurso principal:**  su recurso principal son las truchas y la lubina americana  y Las herramientas necesarias para la pesca  en este caso son dos  la caña de aprendiz pescadorque tiene un costo de 10.000<img src="https://cdn.discordapp.com/emojis/1215392450944835624.webp?size=160&#x26;quality=lossless" alt=":Kamas:" data-size="line">uedes comprarlas al NPC vendedor de objetos  en la casa de los oficios.  y la caña de pescar telescópica que tiene un costo de 1.000<img src="https://cdn.discordapp.com/emojis/1214652202103210075.webp?size=96&#x26;quality=lossless" alt=":Ogrina:" data-size="line">. Puedes comprarla en el NPC tienda Vip

**Diferencia de Cañas**

**La caña de aprendiz de pescador y la caña telescópica** son dos herramientas esenciales para el oficio de pescador en Dofus. Sin embargo, existen algunas diferencias clave entre ambas:

**Rango de pesca:**

* **Caña de aprendiz de pescador:** Tiene un rango de pesca **corto**.
* **Caña telescópica:** Tiene un rango de pesca **largo**.

**Esto significa que con la caña telescópica podrás pescar desde una mayor distancia, lo que te da acceso a una mayor cantidad de peces.**

**Caña de aprendiz pescador:**\
...
Con el oficio pescador puede intercambiar los siguientes Objetos&#x20;
